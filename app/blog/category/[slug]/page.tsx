...
import { Calendar, ArrowRight, User, Folder, ArrowLeft } from 'lucide-react';
        ...
        return (
            <div className="min-h-screen bg-brand-dark pb-24 flex items-center justify-center">
                <div className="text-center p-8 border border-slate-800 rounded-2xl bg-slate-900/50">
                    ...
                    <p className="text-slate-500 mb-6">No articles found for category &quot;{slug}&quot;.</p>
                    <Link href="/blog" className="text-brand-primary hover:text-teal-400 font-medium">
                        Return to Blog &rarr;
                    </Link>
                </div>
            </div>
            ...
            <div className="relative border-b border-slate-800 bg-slate-900/50 py-16 overflow-hidden">
                <div className="container relative z-10 mx-auto px-4 md:px-6">
                    <div className="max-w-3xl">
                        <Link href="/blog" className="inline-flex items-center text-sm font-medium text-brand-primary hover:text-white mb-6 transition-colors">
                        ...
                        <p className="text-lg text-slate-400">
                            Browsing the latest articles for this topic.
                        </p>
                    </div>
                </div>
            </div>
